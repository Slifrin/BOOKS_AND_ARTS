...
export class NoteCreateForm {
    ...
    connectPerson() {
        let fieldPersonIn = this.form.querySelector("input[name='person_id']");
        fieldPersonIn.setAttribute("value", this.personID);
    }
