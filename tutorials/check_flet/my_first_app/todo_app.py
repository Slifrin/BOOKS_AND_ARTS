...
class TodoApp(ft.UserControl):
    def build(self):
        ...
        # application root control (i.e. "view") containing all other controls
        headline = ft.Row(
    ...
    def add_clicked(self, e):
        task = Task(self.new_task.value, self.tabs_changed, self.task_delete)
...
def main(page: ft.Page):
    ...
    # add app to root control to the page
    page.add(todo)
