"""
https://docs.pytest.org/en/stable/example/parametrize.html#parametrization-with-multiple-fixtures
"""
...
def python1(request: pytest.FixtureRequest, tmp_path):
    picklefile = tmp_path / "data.pickle"
    return Python(request.param, picklefile)


@pytest.fixture(params=pythonlist)
def python2(request: pytest.FixtureDef, python1):
